                        ...
                        <div className="container my-5">
                            <div className="row">
                                <div className="col-md-8 p-5 shadow-2xl" >
                                    <h1 style={{ "color": "#006429" }} className="text-2xl font-bold ml-[-5px]">We Are Here to Assist You!</h1>
                                    <div className="row">
                                ...
                                <div className="col-md-4 p-5 shadow-2xl">
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div>
                                                <h2 style={{ "color": "#006429" }} className="text-2xl font-bold">Our Address</h2><hr />
                                            ...
                                            <h2 style={{ "color": "#006429" }} className="text-2xl font-bold mt-4">Available On</h2><hr />
