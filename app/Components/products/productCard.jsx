    ...
    >
      ...
      <div className="flex flex-wrap justify-around mt-3">
        ...
        <div>
          <button
            type="button"
            className="text-green hover:bg-[#006429] focus:ring-4 focus:ring-white-300 font-medium rounded-lg text-sm px-3 py-2.5 me-2 mb-2 dark:bg-white-600 dark:hover:bg-white-700 focus:outline-none dark:focus:ring-white-800 hover:text-white font-bold"
            onClick={() =>
              isInCart(item._id)
