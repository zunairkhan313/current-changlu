...
export default function Footer() {
    ...
    return (
        ...
        <div  className="container-fluid mt-4 bg-slate-100" >
            <div className="container">
             

                <div className="row ">
                    <div className="col-lg-3 flex flex-wrap justify-center align-center mt-5">
                        <div>
                            ...
                            <div className="font-normal text-[18px] mt-3">
                                ...
                                <p className="icon-hover">
                                    ...
                                    <a href="mailto:info@changlutools.pk" className="hover:text-black text-black ">Email: info@changlutools.pk</a>
                                </p>
                            </div>
                            <div className="flex justify-center mt-4">
                                <Link href={"./contact"}>
                                <button className="text-white bg-[#006429] text-sm p-3 hover:rounded-[10px] rounded-[5px]">Contact Us</button>
                                </Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 flex flex-wrap justify-center align-center mt-5">
                        <div>
                            <h3 className="text-center font-bold tracking-widest text-2xl text-[#006429]">EXPLORE</h3>
                            <div className="mt-5">
                    ...
                    <div className="col-lg-3 flex flex-wrap justify-center align-center mt-5">
                        <div>
                            <h3 className="text-center font-bold tracking-widest text-2xl text-[#006429]">PRODUCTS</h3>
                            <div className="mt-5">
                    ...
                    <div className="col-lg-3 flex flex-wrap justify-center align-center mt-5">
                    <h3 id="scan" className="text-center font-bold tracking-widest text-2xl text-[#006429]">SCAN ME</h3>
                        <div id="qr" className="mt-[60px]">
                            <Image 
                            src={code}
                            alt="code"
                            width={190}
                ...
                <div className="flex flex-wrap justify-center align-center bg-[#006429] py-3 justify-around">

                    <div className="mt-1">
                        <p className="text-white text-[13px]">Copyright ©️ 2024 <span className="text-white font-bold">CHANGLU UAE</span> - All Rights Reserved</p>
                    </div>
       
                        <div className="flex justify-center items-center ">
                            <a href="https://www.facebook.com/profile.php?id=61556105407107" className="hover:text-blue-500" onMouseEnter={() => setHoveredIcon('facebook')} onMouseLeave={() => setHoveredIcon(null)}>
                            ...
                            <a href="https://www.instagram.com/changluuae/" className="hover:text-pink-500" onMouseEnter={() => setHoveredIcon('instagram')} onMouseLeave={() => setHoveredIcon(null)}>
